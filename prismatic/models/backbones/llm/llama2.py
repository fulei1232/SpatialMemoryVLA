...
# fmt: off
LLAMA2_7B_PURE_REPOSITORY = os.environ.get(
    "PRISMATIC_LLAMA2_7B_REPO", "meta-llama/Llama-2-7b-hf"
)

LLAMA2_MODELS = {
    # === Pure Meta LLaMa-2 (non-instruct/chat-tuned) Models ===
    "llama2-7b-pure": {
        "llm_family": "llama2", "llm_cls": LlamaForCausalLM, "hf_hub_path": LLAMA2_7B_PURE_REPOSITORY
    },
